    ...
    <div class="register card">
        ...
        <div class="form-inputs">
            <div class="form-input">
                ...
                <div v-if="errors?.name" class="form-input__validation form-input__validation--error">{{ errors?.name }}
                </div>
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
                ...
                <div v-if="errors?.password_confirm" class="form-input__validation form-input__validation--error">{{
